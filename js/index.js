...
var services_data = [{ name: "Herramientas de desarrollo", icon: "herramientas" }, { name: "Software", icon: "software" }, { name: "Base de datos", icon: "base de datos " }, { name: "Proyectos", icon: "proyectos" }, { name: "Metodologia", icon: "Metodologia" }, { name: "Redes", icon: "Redes" }, { name: "Integracion", icon: "Integracion" }];
